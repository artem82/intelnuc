...
#### Пример : 
```yaml
echo "$(tput setaf 2)===================="$(tput sgr 0)"$(tput setaf 3)Добро пожaлывать"$(tput sgr 0)"$(>
figlet home assistant

echo "Точное время на сервере $(date)"

echo "$(tput setaf 2)===================="$(tput sgr 0)"$(tput setaf 1)Свободно ОЗУ"$(tput sgr 0)"$(tput>
echo "Свободно ОЗУ"
free -m

echo "$(tput setaf 2)===================="$(tput sgr 0)"$(tput setaf 1)Загрузка системы"$(tput sgr 0)"$(>
uptime
```
